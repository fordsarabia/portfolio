  ...
  <div class="page">
    ...
    <header class="hero">
      ...
      <div class="profile-card">
        <img src="${c}" alt="Clifford Sarabia" class="avatar">
    ...
    <section id="skills" class="section">
      <h2>Skills</h2>
      <div class="chips">
        ${["Flutter","Dart","PHP","MySQL","HTML","CSS","JavaScript","Git","Bootstrap"].map(o=>`<span class="chip">${o}</span>`).join("")}
      </div>
    </section>
